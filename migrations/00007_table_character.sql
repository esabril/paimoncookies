...
INSERT INTO character (name, title, region, rarity, element, talent_book_type) VALUES
    ...
    ('bennett', 'Беннет', 'mondstadt', 4, 'pyro', 'resistance'),
    ...
    ('jean', 'Джинн', 'mondstadt', 5, 'anemo', 'resistance'),
    ...
    ('eula', 'Эола', 'mondstadt', 5, 'cryo', 'resistance'),
    ...
    ('aloy', 'Элой', 'Вселенная «Horizon Zero Dawn»', 0, 'cryo', 'freedom'),
    ('raiden', 'Райдэн', 'inazuma', 5, 'electro', 'light'),
